...
df %>%
  ...
  geom_textline(family = "IBM Plex Mono", size = 2.74) +
  ...
  theme(text = element_text(size = 8, family = "IBM Plex Mono", color = "#000000"),
        ...
        axis.title.y = element_text(size = 7, family = "IBM Plex Mono", color = "#000000"),
  ...
  annotate(geom = "curve", x = 1990, y = 73000, xend = 1998, yend = 88000,curvature = -0.2, size = 0.5,  arrow = arrow(length = unit(2, "mm"))) +
  annotate(geom = "text", y = 65000, x = 1990, label = "A whopping 59,830%\nincrease for Turkey", hjust = "center", family = "IBM Plex Mono", fontface = "bold", size = 3) +
